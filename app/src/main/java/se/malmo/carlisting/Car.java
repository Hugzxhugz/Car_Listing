...
public class Car {
    ...
    public Car(){
        car_id = car_mileage = car_price = 0;
        car_brand = car_description = car_model_year = "";
    }

    public Car(int car_id, String car_model, String car_brand, String car_model_year, String car_description, int car_price, int car_mileage){
        this.car_id = car_id;
